            ...
            if(res.code == 200){
                ...
                for (var i=0; i<res.jwList.length; i++) {
                    ...
                    var $tbody_HTML = $(
                        ...
                        '   <td><span style="font-size: 13px; ">https://kdocs.cn/l/'+res.jwList[i].jw_url+'</span></td>' +
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if (res.code == 200) {
                ...
                // 创建
                appendOptionsToSelect($("#createJwModal select[name='jw_yccym']"), res.yjsymList);
                
                // 编辑
                appendOptionsToSelect($("#editJwModal select[name='jw_yccym']"), res.yjsmList);
            } else {
