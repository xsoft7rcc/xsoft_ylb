<?php
    ...
    if(isset($_SESSION["yinliubao"])){
        ...
        $jw_end_time = trim($_POST['jw_end_time']);
        $jw_topv = trim($_POST['jw_topv']);
        ...
        // }else if(empty($jw_end_time) || !isset($jw_end_time)){
            
        //     $result = array(
        //         'code' => 203,
        //         'msg' => '结束时间未选择'
        //     );
        // }else if(empty($jw_topv) || !isset($jw_topv)){
        ...
        //     );
            ...
            $getJwCreatUser = $db->set_table('ylb_jumpWeiXin')->find(['jw_id'=>$jw_id]);
            ...
            if($jw_create_user == $LoginUser){
                ...
                // 执行更新
                $updateSQL = $db->set_table('ylb_jumpWeiXin')->update($updateCondition,$updateData);
                if($updateSQL){
